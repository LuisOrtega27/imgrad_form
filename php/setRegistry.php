...
// RE-ORDERING DATA
$newTempArr = ["cod_n" => $COD_N, "coor_utm-n" => $COORD_N, "coor_utm-e" => $COORD_E, "ficha_n" => $FICHA_N, "modification" => $MODIFICATION];
